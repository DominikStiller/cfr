...
def get_ptype(archive_type, proxy_type):
    ...
    ptype_dict = {
        ...
        ('glacier ice', 'ice melt'): 'ice.melt',
        ('glacier ice', 'ice accumulation'): 'ice.accumulation',
        ...
        ('lake sediment', 'accumulation rate'): 'lake.accumulation',
        ...
        ('lake sediment', 'chrysophyte assemblage'): 'lake.chrysophyte',
